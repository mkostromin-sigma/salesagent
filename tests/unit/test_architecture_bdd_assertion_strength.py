...
_HASATTR_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/domain/uc011_accounts.py:452 then_accounts_array_count",
    "bdd/steps/domain/uc011_accounts.py:536 then_empty_accounts",
    "bdd/steps/domain/uc011_accounts.py:590 then_accounts_from_first_page",
    "bdd/steps/domain/uc011_accounts.py:1016 then_has_accounts_array",
    "bdd/steps/domain/uc011_accounts.py:1034 then_response_is_success_variant",
    "bdd/steps/domain/uc011_accounts.py:1043 then_each_error_has_code_message",
    # FIXME(salesagent-beq4): replace hasattr with value assertion
}
...
_COUNT_ONLY_ALLOWLIST: set[str] = {
    ...
    "bdd/steps/generic/then_payload.py:155 then_referral_fields",
    "bdd/steps/generic/then_payload.py:210 then_format_assets",
    ...
    "bdd/steps/domain/uc011_accounts.py:513 then_other_statuses_excluded",
    "bdd/steps/domain/uc011_accounts.py:590 then_accounts_from_first_page",
    "bdd/steps/domain/uc011_accounts.py:1084 then_all_accounts_action",
    "bdd/steps/domain/uc011_accounts.py:1100 then_failed_has_errors",
    "bdd/steps/domain/uc011_accounts.py:1477 then_account_in_db",
    "bdd/steps/domain/uc011_accounts.py:2013 then_governance_agents_stored",
    ...
    "bdd/steps/generic/then_payload.py:119 then_has_referrals",
    # FIXME(salesagent-beq4): replace count-only check with element-level assertion
